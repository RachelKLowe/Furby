...
def make_hacked_inverting(dlc_in="./dlc/dlc2/tu003410.dlc", left_gif="./images/demo_eyes/button_64.gif", right_gif="./images/demo_eyes/button_64.gif", dlc_out="./newdlc.dlc"):
...
#           D.dlc_sections["SPR"].frames[f][7] = eye_palette
    ...
    for i in [ 9, 11, 13]:
        ...
        #frame 1 first:
        for f in D.dlc_sections["SPR"].frame_playlists[i]["frame_indices"][:10] + D.dlc_sections["SPR"].frame_playlists[i]["frame_indices"][19:29]:
        ...
        #frame 2 next:
        for f in D.dlc_sections["SPR"].frame_playlists[i]["frame_indices"][10:19] + D.dlc_sections["SPR"].frame_playlists[i]["frame_indices"][29:38]:
        ...
        #frame 1 first:
        for f in D.dlc_sections["SPR"].frame_playlists[i-1]["frame_indices"][:10] + D.dlc_sections["SPR"].frame_playlists[i-1]["frame_indices"][19:29]:
        ...
        for f in D.dlc_sections["SPR"].frame_playlists[i-1]["frame_indices"][10:19] + D.dlc_sections["SPR"].frame_playlists[i-1]["frame_indices"][29:38]:
